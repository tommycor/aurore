...
var sourcePath = {
	...
	other: [ sourceDirectory + '/fonts/**', sourceDirectory + '/img/**', sourceDirectory + '/partials/**', sourceDirectory + '/*.html', sourceDirectory + '/html/*.html', sourceDirectory + '/models/**' , sourceDirectory + '/videos/**' , sourceDirectory + '/sounds/**' ]
};
